...
const Staff = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("div.sideNav p.orders").click(function (event) {
        event.preventDefault();

        jquery__WEBPACK_IMPORTED_MODULE_0___default()("p.orders + ul.sub").toggle();
    });
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("div.sideNav p.analytics").click(function (event) {
        event.preventDefault();

        jquery__WEBPACK_IMPORTED_MODULE_0___default()("p.analytics + ul.sub").toggle();
    });
};
